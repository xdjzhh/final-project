...
def LSTMmodel():
    ...
    question_input = Input(shape = (120,100))
    ...
    print(dot_embedding)
    x = Bidirectional(LSTM(32,return_sequences=True,dropout=0.1))(dot_embedding)
    print(x.shape)
...
if __name__ == '__main__':
    ...
    model.save('LSTMmodel_alltrain.h5')

    model = load_model('LSTMmodel_alltrain.h5',custom_objects={'AttentionWithContext':AttentionWithContext})
    # print(test_target)
    for file_index in range(5):
